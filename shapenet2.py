...
class ShapeNet2(InMemoryDataset):
    ...
    def __init__(self, root, categories=None, include_normals=True,
        ...
        super(ShapeNet2, self).__init__(root, transform, pre_transform,
                                        pre_filter)
    ...
    def process_filenames(self, filenames):
        ...
        cat_idx = {categories_ids[i]: v for i, v in enumerate(categories_indices)}
